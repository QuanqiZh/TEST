...
struct Queue_Station{
    FIFOQueue* Q;     // a FIFO Queue in station
    double AvgWaitTime; // average total waiting time for all customers in the station
    double totalWait;  // total waiting time in the station
    int inLine; // number of customers in line
    int DestComp; // ID of next component customers are sent to
};
...
//
struct Fork{
    int num;   // number of ports it has
    double* probability; // probabilities for each port
    int* DestComp; // ID of next component customers are sent to
};
...
struct Exit {
    ...
    double totalTime; // system total service time and wait time for all customers
    double minTime; // the maximum time a customer stayed in the system
    double maxTime; // the minimum time a customer stayed in the system
};
